...
public class CollegeDetails {
	...
	private int collgegeStaffStrength;
	...
	public int getCollgegeStaffStrength() {
		return collgegeStaffStrength;
	}
	public void setCollgegeStaffStrength(int collgegeStaffStrength) {
		this.collgegeStaffStrength = collgegeStaffStrength;
	}
	@Override
	public String toString() {
		return "CollegeDetails [collegeName=" + collegeName + ", collegeStudentStrength=" + collegeStudentStrength
				...
				+ ", collegeCode=" + collegeCode + ", collegeEmailId=" + collegeEmailId + ", collgegeStaffStrength="
				+ collgegeStaffStrength + "]";
	}
